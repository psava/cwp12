...
the so-called RTM artifacts, which are visible as low wavenumber energy on the image. 
Commonly, these events are seen as a drawback of the RTM method because they obstruct the geologic
...
Many strategies have been developed to filter the artifacts out from the conventional image. However,
 these events can be used to analyze kinematic synchronization between wavefields reconstructed 
