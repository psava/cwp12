...
%Image splitting:
\multiplot{2}{img05_nn,img05_bn,img05_nb,img05_bb}{width=0.4\textwidth}{Linearity of the imaging condition. We can split the conventional image (~\rfg{img05_ref}) in four cases: $R(\bf{x})^{tt}$ (a), $R(\bf{x})^{rt}$ (b), $R(\bf{x})^{tr}$ (c), $R(\bf{x})^{tt}$ (d)}

%Time-lag splitting":
\multiplot{2}{cit05_nn,cit05_bn,cit05_nb,cit05_bb}{height=0.25\textheight}{Linearity of the extended imaging condition (time-lags). We split ~\rfg{cit05_ref} in four cases: $R(\bf{x},\tau)^{tt}$ (a), $R(\bf{x},\tau)^{rt}$ (b), $R(\bf{x},\tau)^{tr}$ (c), $R(\bf{x},\tau)^{rr}$ (d)}

%Space-lag splitting":
\multiplot{2}{citx05_nn,citx05_bn,citx05_nb,citx05_bb}{height=0.25\textheight}{Linearity of the extended imaging condition (space-lags). We split \rfg{citx05_ref} in four cases: $R(\bf{x},\lambda_x)^{tt}$ (a), $R(\bf{x},\lambda_x)^{rt}$ (b), $R(\bf{x},\lambda_x)^{tr}$ (c), $R(\bf{x},\lambda_x)^{rr}$ (d)}

%Cip splitting":
\multiplot{2}{cip05_nn,cip05_bn,cip05_nb,cip05_bb}{height=0.25\textheight}{ Split of ~\rfg{cip05_ref} in four cases: $R(\bf{x_o},\lambda_x,\tau)^{tt}$ (a), $R(\bf{x_o},\lambda_x,\tau)^{rt}$ (b), $R(\bf{x_o},\lambda_x,\tau)^{tr}$ (c), $R(\bf{x_o},\lambda_x,\tau)^{rr}$ (d)}
