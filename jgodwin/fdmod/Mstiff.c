/* Outputs the stiffness tensor for 2d and 3d elastic media given the correct parameters */
/*
...
int main(int argc, char* argv[])
{
    ...
    if(! sf_getint("dim",&dim)) dim=2; /* 2D = 2, 3D = 3*/
    Fvp      = sf_input ("vp");/* p-wave velocity */
    Fvs      = sf_input ("vs");/* s-wave velocity */
    Fro      = sf_input ("ro");/* density */
    Fepsilon = sf_input ("eps");/* epsilon  */
    Fdelta   = sf_input ("del");/* delta */
    Fgamma   = sf_input ("gam");/*gamma */
    Fnu      = sf_input ("nu");/* nu */
    Falpha   = sf_input ("alp"); /* alpha */
